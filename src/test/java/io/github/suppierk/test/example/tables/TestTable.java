 ...
 */
package io.github.suppierk.test.example.tables;

import io.github.suppierk.test.example.Keys;
import io.github.suppierk.test.example.Public;
...
public class TestTable extends TableImpl<TestTableRecord> {
  ...
  public final TableField<TestTableRecord, UUID> ID =
      createField(DSL.name("id"), SQLDataType.UUID.nullable(false), this, "");

  /** The column <code>public.test.created_at</code>. */
  public final TableField<TestTableRecord, LocalDateTime> CREATED_AT =
